...
// require('./assets/scripts/templates/game-win.js')
...
var updateGame = __webpack_require__(2);
...
var pushCells = function pushCells() {
  cells = $(squares).text().toLowerCase().split('');
  return cells;
};
...
var createBoard = function createBoard() {
  ...
  var winConditions = function winConditions(id, player) {
